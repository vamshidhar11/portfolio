      ...
      <aside className="sidebar">
        <div className="row">
          ...
          <div className="col-12 col-md-9 col-lg-12">
            <p className="lead">
              <strong className="text-uppercase">Mateus Dal Bianco</strong>
              <br />
            </p>
            <p>
              Co-fundador do <a href="http://tripby.org">tripby.org</a>.
            ...
            <ul className="row" style={{ padding: 0, listStyleType: "none" }}>
              <li className="col" style={{ flex: 0 }}>
                <a href="https://github.com/dalbinaco">
                  <img src={githubLogo} alt="" height="24" />
                </a>
              </li>
              <li className="col" style={{ flex: 0 }}>
                <a href="https://linkedin.com/in/dalbinaco">
                  <img src={linkedinLogo} alt="" height="24" />
                </a>
              </li>
              <li className="col" style={{ flex: 0 }}>
                <a href="https://twitter.com/dalbinaco">
